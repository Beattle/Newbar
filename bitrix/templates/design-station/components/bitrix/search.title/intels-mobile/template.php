...
if($arParams["SHOW_INPUT"] != "N"){
	echo "<div id=\"{$CONTAINER_ID}\" class=\"search ghost mar-m-r\">";
		echo "<a class=\"link-block   button  dropdown\" href=\"/\">&nbsp;</a>";
		echo "<div>";
			echo "<form class=\"pad cell-m-100\" action=\"{$arResult["FORM_ACTION"]}\">";
