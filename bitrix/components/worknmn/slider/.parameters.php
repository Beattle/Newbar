...
$arColorSchemes = array(
	'pink'      => GetMessage('WORKNMN_COLOR_SCHEME_PINK'),
	'yellow'    => GetMessage('WORKNMN_COLOR_SCHEME_YELLOW'),
	'orange'    => GetMessage('WORKNMN_COLOR_SCHEME_ORANGE'),
	'siren'     => GetMessage('WORKNMN_COLOR_SCHEME_SIREN'),
	'green'     => GetMessage('WORKNMN_COLOR_SCHEME_GREEN'),
	'blue'      => GetMessage('WORKNMN_COLOR_SCHEME_BLUE'),
);
...
$rsIBlock = CIBlock::GetList(Array("sort" => "asc"), Array("TYPE" => $arCurrentValues["IBLOCK_TYPE_ID2"], "ACTIVE"=>"Y"));
while($arr=$rsIBlock->Fetch())
...
$arComponentParameters = array(
	"GROUPS" => array(
		...
		"JS_OPTIONS" => array(
			"NAME" => GetMessage("WORKNMN_GROUP_JS_OPTIONS"),
			"SORT" => 300
		),
		"PLUGIN_OPTIONS" => array(
			"NAME" => GetMessage("WORKNMN_GROUP_PLUGIN_OPTIONS"),
			"SORT" => 200
		),
	),
	"PARAMETERS" => array(
		...
		"IBLOCK_TYPE_ID2" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("IBLOCK_TYPE2"),
			"TYPE" => "LIST",
		...
		"PREVIEW_TRUNCATE_LEN" => Array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("WORKNMN_PREVIEW_TRUNCATE_LEN"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
		),
		"INTERVAL" => Array(
			"PARENT" => "PLUGIN_OPTIONS",
			"NAME" => GetMessage("WORKNMN_INTERVAL"),
			"TYPE" => "STRING",
			"DEFAULT" => "5",
		),
		"COLOR_SCHEME"=> Array(
			"PARENT" => "PLUGIN_OPTIONS",
			"NAME" => GetMessage("WORKNMN_COLOR_SCHEME"),
			"TYPE" => "LIST",
      "MULTIPLE" => "N",
		...
		"AUTO_PLAY"=> Array(
			"PARENT" => "PLUGIN_OPTIONS",
			"NAME" => GetMessage("WORKNMN_AUTO_PLAY"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"INCLUDE_JQUERY"=> Array(
			"PARENT" => "JS_OPTIONS",
			"NAME" => GetMessage("WORKNMN_INCLUDE_JQUERY"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		"INCLUDE_MODERNIZER"=> Array(
			"PARENT" => "JS_OPTIONS",
			"NAME" => GetMessage("WORKNMN_INCLUDE_MODERNIZER"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
