...
$MESS ['IBLOCK_TYPE2'] = "Тип инфо-блока для рамки товаров";
$MESS ['IBLOCK_IBLOCK2'] = "Инфо-блок рамки товаров";
...
$MESS['WORKNMN_IBLOCK_TYPE']    = 'Тип инфоблока';
$MESS['WORKNMN_IBLOCK_ID']      = 'Инфоблок';
$MESS['WORKNMN_COLOR_SCHEME']   = 'Цвет';
$MESS['WORKNMN_ITEMS_LIMIT']    = 'Количество слайдов';
$MESS['WORKNMN_AUTO_PLAY']      = 'Автопрокрутка';

$MESS['WORKNMN_COLOR_SCHEME_PINK']      = 'Розовый';
$MESS['WORKNMN_COLOR_SCHEME_YELLOW']    = 'Желтый';
$MESS['WORKNMN_COLOR_SCHEME_ORANGE']    = 'Ораньжевый';
$MESS['WORKNMN_COLOR_SCHEME_SIREN']     = 'Сиреневый';
$MESS['WORKNMN_COLOR_SCHEME_GREEN']     = 'Зеленый';
$MESS['WORKNMN_COLOR_SCHEME_BLUE']      = 'Синий';

$MESS['WORKNMN_INCLUDE_JQUERY']        = 'Подключать jQuery (активируйте, если jQuery не подключен на сайте)';
$MESS['WORKNMN_INCLUDE_MODERNIZER']    = 'Подключать Modernizr (активируйте, если Modernizr не подключен на сайте)';

$MESS['WORKNMN_GROUP_JS_OPTIONS']      = 'Настройка JavaScript';
$MESS['WORKNMN_GROUP_PLUGIN_OPTIONS']  = 'Настройка слайдера';

$MESS["WORKNMN_PREVIEW_TRUNCATE_LEN"]  = "Максимальная длина анонса для вывода (только для типа текст)";
$MESS["WORKNMN_INTERVAL"]              = "Интервал прокрутки (секунды)";