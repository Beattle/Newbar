...
$APPLICATION->SetPageProperty("keywords", "Мебель для ресторанов кафе бара заказ Барная кресла столы производство мебели Москве");
$APPLICATION->SetPageProperty("description", "Дизайн Станция - Мебель для кафе, баров и ресторанов. Барные стулья, столы, подстолья, стойки Мебель для кафе, баров и ресторанов. Барные стулья, столы, подстолья, стойки");
$APPLICATION->SetTitle("Мебель для ресторанов, кафе и бара под заказ | Барная мебель - кресла, столы из Италии | Продажа и производство мебели в Москве");
?><?$APPLICATION->IncludeComponent(
	"worknmn:slider",
	"",
	Array(
		"IBLOCK_TYPE_ID" => "wwideslide",
		"IBLOCK_ID" => "6",
		"IBLOCK_TYPE_ID2" => "wwideslide",
		"IBLOCK_ID2" => "5",
...
<div class="sections pad-t bg-2"> <section class="row"> <article class="cell-t-16 first-item eq-height"> <a class="link-block button " href="/catalog/74/" > <figure class="pad vpad"> <img src="/bitrix/templates/design-station/img/cats/1.png"  /> </figure> 
        ...
        <div class="pad text-center">Мебель для дома</div>
       ...
       </a> </article> <article class="cell-t-16 first-item eq-height"> <a class="link-block button " href="/catalog/101/" > <figure class="pad vpad"> <img src="/bitrix/templates/design-station/img/cats/12.png"  /> </figure> 
